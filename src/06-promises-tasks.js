...
async function chainPromises(array, action) {
  const res = [];
  await array.forEach((i) => i.then((data) => res.push(data)));
  const value = res.reduce(action);
  return new Promise((req) => req(value));
}
